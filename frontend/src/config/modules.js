export const modules = {
  ...
  courses: {
    ...
    columns: [
      ...
      { key: "resourceTitle", label: "学习资源" },
      { key: "estimatedMinutes", label: "预计分钟" },
    ...
    fields: [
      ...
      { key: "provider", label: "提供方" },
      { key: "category", label: "分类" },
      { key: "resourceTitle", label: "资源标题" },
      { key: "resourceUrl", label: "资源链接" },
      { key: "resourceSummary", label: "资源简介", type: "textarea" },
      { key: "estimatedMinutes", label: "预计分钟", type: "number" },
  ...
  achievements: {
    ...
    columns: [
      ...
      { key: "auditAction", label: "审核操作" },
      { key: "proofUrl", label: "证明材料" },
  ...
  "job-applications": {
    title: "招聘投递",
    subtitle: "查看学员岗位投递与处理状态",
    tableTitle: "投递记录",
    api: "/api/admin/core/job-applications",
    columns: [
      { key: "id", label: "ID" },
  ...
  "integrity-ratings": {
    title: "诚信评定",
    subtitle: "按学习、签到、成果、论坛和求职行为评定诚信等级",
    tableTitle: "诚信评分",
    ...
    columns: [
      ...
      { key: "signinScore", label: "签到" },
      { key: "achievementScore", label: "成果" },
      { key: "forumScore", label: "论坛" },
      { key: "jobScore", label: "求职" },
    ],
    fields: [],
  },
  jobs: {
    title: "招聘岗位发布",
    subtitle: "管理员发布和维护面向学习者的招聘岗位",
    tableTitle: "岗位列表",
    api: "/api/admin/jobs",
    canCreate: true,
    canEdit: true,
    ...
    fields: [
      ...
      { key: "contact", label: "联系方式" },
      { key: "status", label: "状态", type: "radio", options: ["OPEN", "CLOSED"] },
    ],
  },
};
...
export const menu = [
  ...
  { key: "achievements", label: "成果审核", icon: "Award" },
  { key: "learning-records", label: "学习记录", icon: "ClipboardList" },
  { key: "enrollments", label: "报名审核", icon: "ClipboardList" },
  { key: "forum-posts", label: "论坛管理", icon: "MessagesSquare" },
  { key: "jobs", label: "发布招聘", icon: "BriefcaseBusiness" },
  { key: "job-applications", label: "招聘投递", icon: "BriefcaseBusiness" },
  { key: "integrity-ratings", label: "诚信评定", icon: "Award" },
];
